...
The data are hosted on the opendap: [ocean-data-challenges/2022a_SWOT_karin_error_filtering/](https://ige-meom-opendap.univ-grenoble-alpes.fr/thredds/catalog/meomopendap/extract/MEOM/OCEAN_DATA_CHALLENGES/2022a_SWOT_karin_error_filtering/catalog.html). 
...
| | | | | | | | | |
| GOMEZ_V2      | Sea Surface Height [m]|           **0.002** |            0.0026 |                    **0.002** |                     **0.003** |                           14.8 | no notebook available, spat. variable param |
| GOMEZ_V2      | Geostrophic current [m.s<sup>-1</sup>]|       0.056  |        **0.065**  |               0.050   |                 0.057   |                           12.5 | no notebook available, spat. variable param |
| GOMEZ_V2      | Relative vorticity []|       0.65 |        0.882 |               0.504 |                 0.321 |                           26.6 | no notebook available, spat. variable param |
